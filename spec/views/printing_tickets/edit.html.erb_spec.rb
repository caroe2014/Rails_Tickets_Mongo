...
RSpec.describe "printing_tickets/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit printing_ticket form" do
    render

    assert_select "form[action=?][method=?]", printing_ticket_path(@printing_ticket), "post" do
