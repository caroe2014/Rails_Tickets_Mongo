...
RSpec.describe "master_materials/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit master_material form" do
    render

    assert_select "form[action=?][method=?]", master_material_path(@master_material), "post" do
